...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
	...
	private UnitOfMeasure findUnitOfMeasure(String desription) {
		Optional<UnitOfMeasure> uomOptional = unitOfMeasureRepository.findByDescription(desription);
		if (!uomOptional.isPresent()) {
			throw new RuntimeException("Expected UOM Not Found for the description '" + desription + "'");
		}
		return uomOptional.get();
	}
	
	private Category findCategory(String desription) {
		Optional<Category> categoryOptional = categoryRepository.findByDescription(desription);
		if (!categoryOptional.isPresent()) {
			throw new RuntimeException("Expected Category Not Found for the description '" + desription + "'");
		}
    ...
    UnitOfMeasure teapoonUom = findUnitOfMeasure("Teaspoon");
    UnitOfMeasure dashUom = findUnitOfMeasure("Dash");
    UnitOfMeasure pintUom = findUnitOfMeasure("Pint");
    UnitOfMeasure cupsUom = findUnitOfMeasure("Cup");
